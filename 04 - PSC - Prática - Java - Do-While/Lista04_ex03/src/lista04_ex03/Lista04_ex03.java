package lista04_ex03;

import javax.swing.JOptionPane;

public class Lista04_ex03 {

	public static void main(String[] args) {

		String entrada;
		int nota, salario, idade;
		String sexo,continuar;
do {
		do {
		...
		continuar = JOptionPane.showInputDialog("Deseja executar novamente o algoritmo?(sim/nao)").toUpperCase();
